...
CPPPATH_NODE = '/Users/whydna/local/node/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-O3']
...
LIBDIR = '/Users/whydna/.node_libraries'
LIBPATH_NODE = '/Users/whydna/local/node/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['-O3']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/whydna/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/whydna/local/node'
